...
def parse_args():
    ...
    parser.add_argument("--cars_data", type=str, help="Path to raw data")  # Specify the type for raw data (str)
...
if __name__ == "__main__":
    ...
    lines = [
        f"Raw data path: {args.cars_data}",  # Print the raw_data path
